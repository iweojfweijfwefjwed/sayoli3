...
<?php
 ...
 if (isset($_GET['id'])) {
 	...
 	$nombrecategoria="";
 	switch ($fila[9]) {//este switch asigna un valor numerico a la categoria y lo recepciona la variable idcategoria
	case 1:
...
?>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				<form action="./php/agregarproductos.php?id=2" method="post" enctype="multipart/form-data"><!-- atraves del formulario agregamos un id pra enviarselo por metodo get a la clase agregagrproductos.php, la clase enctype=multipart/form-data, sirve para poder enviar imagenes atraves de este formulario -->
					<!--Nombre-->
				<div class="form-row">
